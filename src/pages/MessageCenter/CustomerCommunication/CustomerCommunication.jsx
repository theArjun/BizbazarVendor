...
const CustomerCommunication = () => {
  ...
  const {data: customerMessages, isLoading:messageLoading}=getVendorCustomerMessages(params)
    useEffect(()=>{
  ...
  return (
    ...
    <CustomerCommunicationTable loading={messageLoading} data={getCustomerMessages()}/>
    </div>
  )
}
