        ...
        <div className={styles.container}>
          ...
          <div className={styles.section}>
            ...
            <div>
              ...
              If you use realtime shipping rate calculation, your shipping
              service may provide its own delivery time. The time provided by
              the shipping service will be displayed instead of the time you
              specify here.
            </div>
          </div>
          <span></span>
