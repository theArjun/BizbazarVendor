...
import styles from "./PaymentMethodsChartCost.module.css";
const Chart = lazy(() => import("react-apexcharts"));
const PaymentMethodsChartCost = () => {
  let options = {
    legend: {
      position: "bottom",
    },
  ...
  return (
    <div className={styles.categories_item_sold}>
      <div className={styles.categories_item_sold_title}>
        Payment methods chart for cost.
      </div>
...
export default PaymentMethodsChartCost;
